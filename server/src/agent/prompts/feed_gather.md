...
Your task names your slice: a source (GitHub, Trendshift, HuggingFace, Hacker News, arXiv, or Reddit) and often an angle or topic. Stay within that slice.
...
[
  {
    "source": "github | trendshift | hf | hackernews | arxiv | reddit",
